...
export default function Add() {
    ...
    const onSubmit = (data) => {
        ...
        formData.append('banner_status', data.banner_status);
        formData.append('banner_picture', files[0]);  
        Swal.fire({
            title: 'บันทึกข้อมูล',
            ...
            if (result.isConfirmed) {
                router.post(`/banner/save`, formData)
            }
        })
    }
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            <div className="col-sm-6">
                                <h1 className="m-0">เพิ่มรูปBanner</h1>
                            </div>
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    <li className="breadcrumb-item"><a href="#">หน้าแรก</a></li>
                                    <li className="breadcrumb-item active">เพิ่มรูปBanner</li>
